...
public class BloomFilter<T> {
    ...
    private Map<T, Integer> seenCount = new HashMap<>(); // this will just keep track of how many same hash values we've seen so far and how many times while writing to bloom filter. No functional purpose
