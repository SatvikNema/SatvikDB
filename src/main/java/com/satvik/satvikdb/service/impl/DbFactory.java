  ...
  public static DbService getDbService(TypesEnum typesEnum) {
    ...
    switch (typesEnum) {
      case SIMPLE:
        ...
        dbService.init(
            SimpleDbConstants.ROOT_DIR,
            SimpleDbConstants.FILE_NAME,
            SimpleDbConstants.INDEX_FILE_NAME,
            null);
      case LSM_SSTABLE:
        dbService = new LsmDb();
        dbService.init(
            LsmDbConstants.ROOT_DIR,
            LsmDbConstants.FILE_NAME_STARTS_WITH,
            LsmDbConstants.INDEX_FILE_NAME_STARTS_WITH,
            LsmDbConstants.WAL_NAME);
    }
    return dbService;
  }
}
