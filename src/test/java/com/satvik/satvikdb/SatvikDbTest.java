...
class SatvikDbTest {
  ...
  @Disabled
  @DisplayName(
      "Do a comprehensive read and write on the database. assert general correctness. No bloom filters involved. Disabled by default. update LsmDbConstants.ROOT_DIR before running")
  void testMain_1() {
  ...
  @Disabled
  @DisplayName(
      "Do a comprehensive read and write on the database. assert general correctness. With bloom filters. Disabled by default. update LsmDbConstants.ROOT_DIR before running")
  void testMain_2() {
